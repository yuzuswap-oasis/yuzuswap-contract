...
interface OkenChainTokenTestBInterface extends ethers.utils.Interface {
  functions: {
    "a()": FunctionFragment;
...
export class OkenChainTokenTestB extends Contract {
  ...
  interface: OkenChainTokenTestBInterface;

  functions: {
    a(overrides?: PayableOverrides): Promise<ContractTransaction>;
  ...
  estimateGas: {
    a(overrides?: PayableOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    a(overrides?: PayableOverrides): Promise<PopulatedTransaction>;
