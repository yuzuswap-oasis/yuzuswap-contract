...
interface OkenChainTokenTestAInterface extends ethers.utils.Interface {
  functions: {
    "a()": FunctionFragment;
...
export class OkenChainTokenTestA extends Contract {
  ...
  interface: OkenChainTokenTestAInterface;
